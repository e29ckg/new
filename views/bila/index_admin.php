...
/* BASIC ;*/	
	...
	$('#activity-modal').on('hidden.bs.modal', function () {
 		location.reload();
		    ...
		    $("div.toolbar").html('<div class="text-right"><button id="act-create" class="btn btn-danger btn-md" alt="act-create"><i class="fa fa-plus "></i> เพิ่มใบลาป่วย</button> <button id="act-create-b" class="btn btn-primary btn-md" alt="act-create"><i class="fa fa-plus "></i> เพิ่มใบลาพักผ่อน</button></div>');
