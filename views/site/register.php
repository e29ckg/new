...
<html lang="en-us" id="extr-page">
	...
	<body id="login">
		...
		<header id="header">
			...
			<span id="extr-page-header-space"> <span class="hidden-mobile hiddex-xs">Already registered?</span> <a href="index.php?r=site/login" class="btn btn-danger">Sign In</a> </span>
